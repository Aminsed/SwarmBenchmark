...
void constructTours(Ant* ants, double* pheromones, int* bestTour, double* bestTourLength, std::mt19937& rng) {
...
void runACO(Ant* ants, double* pheromones, int* bestTour, double* bestTourLength, std::mt19937& rng) {
    for (int iter = 0; iter < MAX_ITERATIONS; iter++) {
        constructTours(ants, pheromones, bestTour, bestTourLength, rng);
...
int main() {
    ...
    runACO(ants, pheromones, bestTour, &bestTourLength, rng);
